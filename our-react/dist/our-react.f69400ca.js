...
var Nex = function Nex(props) {
  return React.createElement("div", {
    className: "react-2020"
  }, React.createElement("h1", null, "hello, person!"), React.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto deleniti, repellat ducimus eligendi voluptatum ullam, laboriosam suscipit deserunt necessitatibus, harum minus sed amet! Ea ratione quis, qui, vitae cumque quod."));
};
...
render(React.createElement(Nex, null), document.querySelector('#app'));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3955" + '/');
...
//# sourceMappingURL=/our-react.f69400ca.js.map