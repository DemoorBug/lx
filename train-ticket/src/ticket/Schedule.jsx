...
const ScheduleRow = memo(function (props){
  const {
    index,
    station,
    arriveTime,
  ...
  return (
    <li>
      ...
      <div className={classnames('row', {
          grey: beforeDepartStation || afterDepartStation,
        })}>
...
const Schedule = memo(function Schedule(props) {
  ...
  useEffect(() => {
    const url = new URI('/rest/schedule.json')
  ...
  }, [date, trainNumber, departStation, arriveStation, setScheduleList])
